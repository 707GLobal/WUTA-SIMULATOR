...
static const _Cone_type_support_symbol_names_t _Cone_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wuta_msgs, msg, Cone)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wuta_msgs, msg, Cone)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wuta_msgs, msg, Cone)() {
  return &::wuta_msgs::msg::rosidl_typesupport_c::Cone_message_type_support_handle;
}
