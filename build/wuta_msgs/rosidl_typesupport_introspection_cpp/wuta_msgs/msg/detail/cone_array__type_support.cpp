...
{
  new (message_memory) wuta_msgs::msg::ConeArray(_init);
}

void ConeArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wuta_msgs::msg::ConeArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConeArray_message_member_array[2] = {
  {
    ...
    offsetof(wuta_msgs::msg::ConeArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wuta_msgs::msg::ConeArray, cones),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ConeArray_message_members = {
  ...
  2,  // number of fields
  sizeof(wuta_msgs::msg::ConeArray),
...
get_message_type_support_handle<wuta_msgs::msg::ConeArray>()
{
  return &::wuta_msgs::msg::rosidl_typesupport_introspection_cpp::ConeArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wuta_msgs, msg, ConeArray)() {
  return &::wuta_msgs::msg::rosidl_typesupport_introspection_cpp::ConeArray_message_type_support_handle;
}
