...
#include "wuta_msgs/msg/detail/mission_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wuta_msgs::msg::MissionState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wuta_msgs::msg::MissionState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wuta_msgs::msg::MissionState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wuta_msgs::msg::MissionState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wuta_msgs::msg::MissionState *>(
    untyped_ros_message);
...
{
  return &wuta_msgs::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wuta_msgs, msg, MissionState)() {
  return &wuta_msgs::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
