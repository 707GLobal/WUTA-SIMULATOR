...
static const _Cone_type_support_symbol_names_t _Cone_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wuta_msgs, msg, Cone)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wuta_msgs, msg, Cone)),
  }
};
...
{
  return &::wuta_msgs::msg::rosidl_typesupport_cpp::Cone_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wuta_msgs, msg, Cone)() {
  return get_message_type_support_handle<wuta_msgs::msg::Cone>();
}
