...
class Metaclass_Cone(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'COLOR_UNKNOWN': cls.__constants['COLOR_UNKNOWN'],
            'COLOR_BLUE': cls.__constants['COLOR_BLUE'],
            'COLOR_YELLOW': cls.__constants['COLOR_YELLOW'],
            'COLOR_ORANGE': cls.__constants['COLOR_ORANGE'],
        }

    @property
    def COLOR_UNKNOWN(self):
        """Message constant 'COLOR_UNKNOWN'."""
        return Metaclass_Cone.__constants['COLOR_UNKNOWN']

    @property
    def COLOR_BLUE(self):
        """Message constant 'COLOR_BLUE'."""
        return Metaclass_Cone.__constants['COLOR_BLUE']

    @property
    def COLOR_YELLOW(self):
        """Message constant 'COLOR_YELLOW'."""
        return Metaclass_Cone.__constants['COLOR_YELLOW']

    @property
    def COLOR_ORANGE(self):
        """Message constant 'COLOR_ORANGE'."""
        return Metaclass_Cone.__constants['COLOR_ORANGE']
