...
bool wuta_msgs__msg__mission_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wuta_msgs.msg._mission_state.MissionState", full_classname_dest, 41) == 0);
  }
  wuta_msgs__msg__MissionState * ros_message = _ros_message;
  {  // header
  ...
  {  // localization_mode
    ...
    assert(PyLong_Check(field));
    ros_message->localization_mode = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // description
...
PyObject * wuta_msgs__msg__mission_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wuta_msgs.msg._mission_state");
  ...
  {  // localization_mode
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->localization_mode);
    {
