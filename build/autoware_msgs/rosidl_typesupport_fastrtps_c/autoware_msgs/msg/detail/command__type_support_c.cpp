...
#include "autoware_msgs/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
using _Command__ros_msg_type = autoware_msgs__msg__Command;
...
size_t get_serialized_size_autoware_msgs__msg__Command(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name dv_state
  {
    size_t item_size = sizeof(ros_message->dv_state);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_msgs__msg__Command(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_msgs
size_t max_serialized_size_autoware_msgs__msg__Command(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_msgs__msg__Command;
    is_plain =
      (
      offsetof(DataType, dv_state) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_msgs__msg__Command(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_msgs, msg, Command)() {
