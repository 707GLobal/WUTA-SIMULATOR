...
#include "autoware_msgs/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_msgs::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_msgs::msg::Command & ros_message)
{
  // Member: speed
  cdr >> ros_message.speed;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_msgs::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_msgs::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_msgs::msg::Command *>(
    untyped_ros_message);
...
{
  return &autoware_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_msgs, msg, Command)() {
  return &autoware_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
