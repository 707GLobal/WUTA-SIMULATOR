...
class Command(metaclass=Metaclass_Command):
    ...
    def __init__(self, **kwargs):
        ...
        self.dv_state = kwargs.get('dv_state', int())
    ...
    def __eq__(self, other):
        ...
        if self.angle != other.angle:
            return False
        if self.dv_state != other.dv_state:
            return False
        return True
    ...
    @builtins.property
    def dv_state(self):
        """Message field 'dv_state'."""
        return self._dv_state

    @dv_state.setter
    def dv_state(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'dv_state' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'dv_state' field must be an integer in [-2147483648, 2147483647]"
        self._dv_state = value
